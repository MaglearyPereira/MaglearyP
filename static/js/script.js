...
//-----------------------------------------------------------------
 function buscarProductos(){
  ...
  .then(res=>{
   ...
   let url =`/ruta?nombre=${res.producto[0].nombre}&codigo=${res.producto[0].codigo}&precio=${res.producto[0].precio}&descripcion=${res.producto[0].descripcion}&calidad=${res.producto[0].calidad}&url=${res.producto[0].url}&cantidad=${res.producto[0].cantidad}`;
